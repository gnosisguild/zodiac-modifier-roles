...
_Note: Zodiac Roles Modifier is designed to work seamlessly with [Zodiac Pilot](https://pilot.gnosisguild.org/), a new paradigm in wallet-dapp interaction that allows authorized roles to easily craft multi-send batch transactions on behalf of an onchain entity through a simple interface._
