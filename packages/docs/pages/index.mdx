...
*Note: The Zodiac Roles toolkit can be combined with [Pilot](https://pilot.gnosisguild.org/), a new paradigm in wallet-dapp interaction that allows authorized roles to easily craft multi-send batch transactions on behalf of an onchain entity through a simple interface.*
