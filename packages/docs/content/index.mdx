...
- **Zodiac Roles App:** A web app for navigating your roles and permissions
- **Zodiac Roles SDK:** A TypeScript software development kit to programmatically manage roles and permissions
  <Callout type="info">
    Zodiac Roles Modifier is part of [Zodiac](https://www.zodiac.eco), an
    operating system for organizational smart accounts. The Zodiac app allows
    authorized roles to seamlessly execute transactions on behalf of an
    onchain entity through a simple interface.
  </Callout>
