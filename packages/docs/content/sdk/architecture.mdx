...
This layer provides the core types and structural operations on role configurations, operating on JSON objects matching the `Role` type of the subgraph schema.
...
- subtracting and comparing target configurations

Reading current role configurations and applying configuration changes are handled by the [Zodiac SDK](https://github.com/gnosisguild/zodiac-os-sdk).
