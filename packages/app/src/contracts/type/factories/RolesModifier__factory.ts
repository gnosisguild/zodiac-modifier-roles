...
import type { RolesModifier, RolesModifierInterface } from "../RolesModifier";
...
export class RolesModifier__factory {
  static readonly abi = _abi;
  static createInterface(): RolesModifierInterface {
    return new utils.Interface(_abi) as RolesModifierInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RolesModifier {
    return new Contract(address, _abi, signerOrProvider) as RolesModifier;
  }
}
