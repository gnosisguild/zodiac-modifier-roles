...
export default function IndeterminateCheckbox() {
  ...
  const children = (
    <Box sx={{ display: 'flex', flexDirection: 'column', ml: 3 }}>
      <FormControlLabel
        label={<Typography variant="body2" className={classes.function}>parameter1</Typography>}
        control={<Checkbox size="small" checked={checked[0]} onChange={handleChange2} />}
      />
      <FormControlLabel
        label={<Typography variant="body2" className={classes.function}>parameter2</Typography>}
    ...
    <Box>
      ...
      <Box className={classes.root}>
        ...
        >
          ...
          >
            <FormControlLabel
              label={<Typography variant="body1" className={classes.function}>denyAddList</Typography>}
              control={
                <Checkbox
                  checked={checked[0] && checked[1]}
                  indeterminate={checked[0] !== checked[1]}
