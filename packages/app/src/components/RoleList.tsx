...
import { Box, Button, IconButton, Table, TableHead, TableBody, TableRow, TableCell, makeStyles} from "@material-ui/core"
            ...
            <TableRow key={role.id} className={classes.tableRow}>
              ...
              <TableCell className={classes.tableCell}>
                <Box display="flex" justifyContent="flex-end">
                  ...
                  <Box sx={{mr: 1}}>
                    <IconButton size="small" aria-label="Delete Role" className={clsx(classes.iconButton, classes.deleteButton)}>
