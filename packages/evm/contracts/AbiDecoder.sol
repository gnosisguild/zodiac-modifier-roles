...
library AbiDecoder {
    ...
    function inspect(
        ...
        assert(
            layout._type == Encoding.Calldata ||
                layout._type == Encoding.AbiEncoded
        );
        /*
        ...
        __block__(
            data,
            layout._type == Encoding.Calldata ? 4 : 0,
    ...
    function _walk(
        ...
        if (_type == Encoding.Static) {
            ...
            payload.size += 32;
        } else if (_type == Encoding.Calldata || _type == Encoding.AbiEncoded) {
            __block__(
                data,
                location + 32 + (_type == Encoding.Calldata ? 4 : 0),
                layout.children.length,
                layout,
                payload
            );
    ...
    function __block__(
        ...
        bool isArray = layout._type == Encoding.Array;
        uint256 offset;
