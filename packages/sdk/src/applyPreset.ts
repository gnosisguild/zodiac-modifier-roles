...
import { PlaceholderValues, PermissionPreset } from "./presets/types"
 ...
 *
 */
export const applyPreset = async <P extends PermissionPreset>(
  address: string,
  roleKey: string,
  preset: P,
 ...
 *
 */
export const encodeApplyPreset = async <P extends PermissionPreset>(
  address: string,
  roleKey: string,
  preset: P,
  placeholderValues: PlaceholderValues<P>,
 ...
 *
 */
export const encodeApplyPresetMultisend = async <P extends PermissionPreset>(
  address: string,
  roleKey: string,
  preset: P,
  placeholderValues: PlaceholderValues<P>,
 ...
 *
 */
export const encodeApplyPresetTxBuilder = async <P extends PermissionPreset>(
  address: string,
  roleKey: string,
  preset: P,
  placeholderValues: PlaceholderValues<P>,
