...
//Contracts
const AURABALBT_DEPOSITOR_WRAPPER_ADDRESS =
...
const AURABAL_BASE_REWARD_POOL_ADDRESS =
...
export const allowAuraLocking = (): PresetAllowEntry[] => {
  return [
    ...
    ...allowErc20Approve(
      [B_80BAL_20WETH_ADDRESS],
      [AURABALBT_DEPOSITOR_ADDRESS]
    ),
    ...
    {
      targetAddress: AURABALBT_DEPOSITOR_WRAPPER_ADDRESS,
      signature: "deposit(uint256,uint256,bool,address)",
    },
    {
      targetAddress: AURABALBT_DEPOSITOR_ADDRESS,
      signature: "deposit(uint256,uint256,bool,address)",
    },
    {
    ...
    {
      targetAddress: SNAPSHOT_DELEGATION_ADDRESS,
