...
const preset = {
  ...
  allow: [
    ...
    // ...allowErc20Approve([SLP_WETH_GNO], [MINI_CHEF_V2]),
    ...
    //     send: true,
    // },
    allow.gnosis.realt.gateway["depositETH"](realt.LENDING_POOL, AVATAR, 0, {
      send: true,
    }),
    ...
    //     }
    // },
    allow.gnosis.realt.variableDebtrmmWXDAI["approveDelegation"](realt.GATEWAY),
