...
const iface = Interface.from([
  ...
  "function hashTypedDomain(bytes data, ((uint8 _type, uint256[] fields)[] layout, bytes32[] typeHashes) types) pure returns (bytes32)",
  "function hashTypedMessage(bytes domain, bytes message, ((uint8 _type, uint256[] fields)[] layout, bytes32[] typeHashes) types) pure returns (bytes32 result)",
  "function hashTypedSafeMessage(bytes domain, bytes message, ((uint8 _type, uint256[] fields)[] layout, bytes32[] typeHashes) types) view returns (bytes32)",
  "function signMessage(bytes message)",
  "function signTypedMessage(bytes domain, bytes message, ((uint8 _type, uint256[] fields)[] layout, bytes32[] typeHashes) types)",
])
